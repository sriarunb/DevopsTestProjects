...
<form id="formID" method="post" action="feedback_insert.php">
 <table align="center" class="table table-striped table-bordered table-hover">
    <table width="424" height="249" border="0" align="center">
      <tr>
      ...
      <tr>
        ...
        <td><label for="feedback_description"></label>
          <textarea name="feedback_description" class="validate[required] form-control" id="feedback_description"></textarea></td>
      </tr>
      <tr>
        <td>Feedback Date</td>
        <td><label for="feedback_date"></label>
        <input type="text" name="feedback_date" readonly=""  value="<?php echo date('Y-m-d'); ?>"  class="validate[required,custom[date]] form-control" id="feedback_date"  /></td>
      </tr>
      <tr>
