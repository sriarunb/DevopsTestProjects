...
&nbsp;&nbsp;&nbsp;</td>
    ...
    <td width="249"><input type="submit" name="Submit" class="btn btn-primary" value="SEARCH"></td>
			  ...
			  $date2=$_POST['date2'];
			   ?>
			  <h4>From Date : <font color="#003399"><?php echo $date1; ?> </font>&nbsp;&nbsp; To Date: <font color="#003399"><?php echo $date2?></font></h4>
  ...
  $tot=0;
  $sql="select * from customer_fees_details cfd,customer_details cd where cfd.customer_id=cd.customer_id and cfd.fees_date  between '$date1' and '$date2'";
  ...
  <tr>
    ...
    <th width="97"><div align="left">Total Fees Amount</div></th>
