 ...
 <div align="center">
      ...
      <table width="300" border="0" align="center">
        <tr>
          ...
          <tr>
          <td>Fees Amount</td>
          <td><label for="fees_amount">
            <input type="text" name="fees_amount" id="fees_amount" class="validate[required,custom[onlyNumber]] form-control" />
          </label></td>
        </tr>
        <tr>
          <td>Fees Date</td>
          <td><label for="fees_date"></label>
          <input type="text" name="fees_date" id="fees_date" class="validate[required,custom[date]] form-control" /></td>
        </tr>
        <tr>
