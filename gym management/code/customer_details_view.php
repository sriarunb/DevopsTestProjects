...
<body>
  ...
  <tr>
    ...
    <td><a href="customer_details_edit.php?customer_id=<?php echo $row['customer_id'];?>">Edit</a></td>
	<td><a href="customer_details_delete.php?customer_id=<?php echo $row['customer_id'];?>">Delete</a></td>
  </tr>
  <?php
  }
  ?>
