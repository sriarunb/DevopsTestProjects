...
<form  id="formID" method="post" action="gym_course_insert.php">
  <div align="center">
    <table width="300" border="0">
      ...
      <tr>
        ...
        <input type="text" name="course_description" id="course_description" class="validate[required] form-control"   /></td>
      </tr>
      <tr>
        <td>Course Fees</td>
        <td><label for="course_fees"></label>
        <input type="text" name="course_fees" id="course_fees" class="validate[required] form-control"  /></td>
      </tr>
      <tr>
