...
<body>
  ...
  $sl=1;
  include('db_connect.php');
   $sql="select * from gym_course_to_customer gctc,customer_details cd, gym_courses gc where gctc.gym_course_id=gc.gym_course_id and gctc.customer_id=cd.customer_id";
