...
include('db_connect.php');
			 ...
			 //echo $sql2="select sum(course_fees) as cf from  gym_course_to_customer gcc,gym_courses gc where gcc.gym_course_id=gc.gym_course_id and gcc.customer_id='$customer_id'";
			  $sql2="select sum(course_fees) as cf from  gym_course_to_customer gcc,gym_courses gc where gcc.customer_id=gc.gym_course_id and gcc.customer_id='$customer_id'";
