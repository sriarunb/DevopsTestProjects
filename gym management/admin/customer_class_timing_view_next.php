...
$class_timing_id=$_POST['class_timing_id'];
  $sql="select * from customer_class_timing cct,customer_details cd,class_timing ct where cct.customer_id=cd.customer_id and cct.class_timing_id=ct.class_time_id and  cct.class_timing_id='$class_timing_id'";
  ...
  <tr>
    <th><div align="center">Total Customer </div></th>
